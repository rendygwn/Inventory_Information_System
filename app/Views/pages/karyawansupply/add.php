...
<title>Tambah Karyawan Supply &mdash; ROBONESIA.ID</title>
<?= $this->endSection() ?>
    ...
    <div class="section-body">
        ...
        <div class="card">
            <div class="card-header">
                <h4>Buat Data Karyawan Supply</h4>
            </div>
            <div class="card-body col-md-6">
                <form action="<?= site_url('karyawansupply') ?>" method="post" autocomplete="off">
                    <?= csrf_field() ?>
