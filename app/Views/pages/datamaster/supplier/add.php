...
<title>Tambah Supplier &mdash; ROBONESIA.ID</title>
<?= $this->endSection() ?>
            ...
            <div class="card-body col-md-6">
                <form action="<?= site_url('supplier') ?>" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kd_supplier" class="form-control" placeholder="Masukan Kode Supplier, Ex : SP001" required autofocus>
                    </div>
                    <div class="form-group">
                        <label>Nama *</label>
