...
<head>
    ...
    <title>Register &mdash; ROBONESIA.ID</title>
                ...
                <div class="row">
                    <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                        <div class="login-brand">
                            <img src="<?= base_url() ?>/template/assets/img/logo_robonesia.jpg" alt="logo" alt="logo" width="150" class="">
                        </div>
